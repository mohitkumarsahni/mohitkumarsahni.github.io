...
!function (e) {
    ...
    return function o(s, u, i) {
        ...
        1: [function (e, t, n) {
            var h = e("github-calendar-parser"), y = e("elly"), v = e("add-subtract-date"), M = e("formatoid"),
                x = "MMM D, YYYY", _ = "MMMM D",
            ...
            t.exports = function (b, e, m) {
                ...
                return function g() {
                    return m.getCalendar(e).then(function (e) {
                        ...
                        t.innerHTML = e;
                        var n, u, r = t.querySelector(".js-yearly-contributions");
                        if (y(".position-relative h2", r).remove(), r.querySelector("include-fragment")) setTimeout(g, 500); else {
                            if (!0 === m.responsive) {
                                var a = r.querySelector("svg.js-calendar-graph-svg"), o = a.getAttribute("width"),
            ...
            var r = e("iterate-object"), a = e("sliced");
            ...
            var r = e("months"), a = e("days"), o = e("fillo"), s = e("parse-it").Parser, u = {
                YYYY: function (e, t) {
            ...
            t.exports = function (e) {
                ...
                return e.split("\n").slice(2).map(function (e) {
                    ...
                    var t = e.match(/data-level="([0-9\-]+)"/i), n = e.match(/data-date="([0-9\-]+)"/),
                        r = e.match(/data-count="([0-9]+)"/);
                    if (t = t && t[1], n = n && n[1], r = r && +r[1], t) {
                        var a = {fill: i[t], date: new Date(n), count: r, level: t};
            ...
            var o = e("regex-escape"), s = (r(u, [{
                key: "run", value: function (e, t) {
                    var n = "";
                    t = t || [];
                    do {
                        var r = e.match(this.re), a = r && r[1], o = a || e.charAt(0);
                        if (a) {
                            var s = this.obj[a];
